window.onload = function () {
    ...
    setLog = function (tank) {
        ...
        if (tank.scalePosition === 'far') {
            scaleWidth.innerHTML = window.getComputedStyle(tank.getElementsByClassName('jqx-scale')[1]).getPropertyValue('width');
            scaleHeight.innerHTML = window.getComputedStyle(tank.getElementsByClassName('jqx-scale')[1]).getPropertyValue('height');
        }
        else {
            scaleWidth.innerHTML = window.getComputedStyle(tank.getElementsByClassName('jqx-scale')[0]).getPropertyValue('width');
            scaleHeight.innerHTML = window.getComputedStyle(tank.getElementsByClassName('jqx-scale')[0]).getPropertyValue('height');
        }
        trackWidth.innerHTML = window.getComputedStyle(tank.getElementsByClassName('jqx-track')[0]).getPropertyValue('width');
        trackHeight.innerHTML = window.getComputedStyle(tank.getElementsByClassName('jqx-track')[0]).getPropertyValue('height');
    }
