window.onload = function (event) {
    ...
    radioButtons[0].addEventListener('change', function () {
        document.querySelector('jqx-drop-down-button').resizeMode = 'none';
    });

    radioButtons[1].addEventListener('change', function () {
        document.querySelector('jqx-drop-down-button').resizeMode = 'vertical';
    });

    radioButtons[2].addEventListener('change', function () {
        document.querySelector('jqx-drop-down-button').resizeMode = 'horizontal';
    });

    radioButtons[3].addEventListener('change', function () {
        document.querySelector('jqx-drop-down-button').resizeMode = 'both';
    });
