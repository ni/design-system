window.onload = function (event) {
    ...
    radioButtons[0].addEventListener('change', function () {
        document.querySelector('jqx-drop-down-list').resizeMode = 'none';
    });

    radioButtons[1].addEventListener('change', function () {
        document.querySelector('jqx-drop-down-list').resizeMode = 'vertical';
    });

    radioButtons[2].addEventListener('change', function () {
        document.querySelector('jqx-drop-down-list').resizeMode = 'horizontal';
    });

    radioButtons[3].addEventListener('change', function () {
        document.querySelector('jqx-drop-down-list').resizeMode = 'both';
    });
