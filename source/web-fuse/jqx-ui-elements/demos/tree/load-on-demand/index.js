window.onload = function () {
    ...
    tree.addEventListener("expand", function (event) {
        ...
        setTimeout(function () {
            const newItem1 = document.createElement('jqx-tree-item'),
                newItem2 = document.createElement('jqx-tree-item');
            ...
            if (event.detail.item.level < 4) {
                newItemsGroup = document.createElement('jqx-tree-items-group');
