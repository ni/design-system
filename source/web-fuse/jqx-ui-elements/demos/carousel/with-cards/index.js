window.onload = function () {
    ...
    carousel.dataSource = [
        {
            HTMLcontent: `<jqx-card>
                            <img src="${basePath}carousel-small-1.jpg" style="width:100%;"/>
                        ...
                        <jqx-card>
                            <img src="${basePath}carousel-small-2.jpg" style="width:100%;"/>
                        ...
                        <jqx-card>
                            <img src="${basePath}carousel-small-3.jpg" style="width:100%;"/>
        ...
        {
            HTMLcontent: `<jqx-card>
                            <img src="${basePath}carousel-small-4.jpg" style="width:100%;"/>
                        ...
                        <jqx-card>
                            <img src="${basePath}carousel-small-5.jpg" style="width:100%;"/>
                        ...
                        <jqx-card>
                            <img src="${basePath}carousel-small-6.jpg" style="width:100%;"/>
        ...
        {
            HTMLcontent: `<jqx-card>
                            <img src="${basePath}carousel-small-7.jpg" style="width:100%;"/>
                            <h3>Nulla mollis velit</h3>
                            <p>
                        ...
                        <jqx-card>
                            <img src="${basePath}carousel-small-8.jpg" style="width:100%;"/>
                        ...
                        <jqx-card>
                            <img src="${basePath}carousel-small-9.jpg" style="width:100%;"/>
